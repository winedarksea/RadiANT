 ...
 * CMakeLists.txt): the radiant_core module is a separate CMake target and never
...
#ifndef RADIANT_CORE_TESTS_GATE_FAKE_HAL_NRF_TIMER_H_
#define RADIANT_CORE_TESTS_GATE_FAKE_HAL_NRF_TIMER_H_
...
#endif /* RADIANT_CORE_TESTS_GATE_FAKE_HAL_NRF_TIMER_H_ */
