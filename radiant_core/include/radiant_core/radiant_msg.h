 ...
 * typedef a handful of radiant_core entry points return.
 *
 ...
 * radiant_on_message() are now defined inside radiant_core, and it is
 ...
 * docs/sdk-ant-contract.md for the event path and radiant_core/include's own
 * HAL contract. See docs/decisions/0002-clean-room-policy.md.
 */

#ifndef RADIANT_CORE_RADIANT_MSG_H_
#define RADIANT_CORE_RADIANT_MSG_H_
 ...
 * radiant_core/include/radiant_core/radiant_wire.h and src/ant_wire.h's
 * aliases of it).
 */
...
#endif /* RADIANT_CORE_RADIANT_MSG_H_ */
