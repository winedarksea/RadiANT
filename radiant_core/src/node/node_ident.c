 ...
 *
 * Calls radiant_core; radiant_core does not know this file exists
			       ...
			       uint64_t wall_s)
{
	 ...
	 * battery change must not hand radiant_core an already-used epoch. */
...
int node_ident_pair_begin(uint8_t ch, uint8_t timeout_s)
{
	...
	/* 2. Open radiant_core's pairing context; no key exists yet. */
