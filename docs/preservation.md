...
- A `core` or `stub` build carries no `libant.a` and has none of this problem.
  Once `radiant` can produce an equivalent readback, that is the image this
