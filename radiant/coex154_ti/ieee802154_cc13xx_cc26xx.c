 ...
 *
 * WHY IT EXISTS. Under CONFIG_RADIANT_BACKEND_CC26XX_COEX the ANT link
 ...
 * radiant/CMakeLists.txt compiles driverlib/rfc.c itself (hal_ti compiles
 ...
 * their upstream defaults rather than duplicated into radiant/Kconfig:
...
static void cmd_ieee_rx_callback(RF_Handle h, RF_CmdHandle ch, RF_EventMask e)
{
	 ...
	 * recover from. Under CONFIG_RADIANT_BACKEND_CC26XX_COEX there is
