 ...
 * they differ), from radiant/include/radiant/radiant_radio_hal.h, and from
 ...
 * implementation in this repository is radiant/spike/rx_raw/src/main.c, which
 ...
 *       -I radiant/include -fsyntax-only radiant/src/radiant_frame.c
 *
