 ...
 *
 * Provenance: clean-room. Written from radiant/include/radiant/radiant_radio_hal.h alone -
 ...
 * other implementation in this tree is radiant/tests/fake_radio.c (a
 ...
 * radiant/CMakeLists.txt selects between them via RADIANT_BACKEND.
 *
...
static const struct radiant_radio_caps null_caps = {
	.name = "null (no radio; radiant link-layer bring-up only)",
