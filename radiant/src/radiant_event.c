 ...
 *
 * Provenance: clean-room. Written from radiant/include/radiant/radiant_event.h (which
 * carries the reasoning), from radiant/include/radiant/radiant_msg.h and
 * docs/sdk-ant-contract.md, from radiant/include/radiant/radiant_radio_hal.h for the
 * t_sync contract and the callback rules, and from
 * radiant/include/radiant/radiant_wire.h - generated from
 ...
 *
 * This file includes no Zephyr header and nothing outside radiant beyond
 ...
 *       -I radiant/include -I radiant/tests \
 *       -fsyntax-only radiant/src/radiant_event.c
 *
