...
#ifndef RADIANT_RADIANT_WIRE_H_
#define RADIANT_RADIANT_WIRE_H_
 ...
 */
#define RADIANT_WIRE_SYNC_TX                                 0xA4
 ...
 * from this. [bridge]
 */
#define RADIANT_WIRE_MESG_MAX_SIZE                           41
...
#define RADIANT_WIRE_MESG_INVALID_ID                         0x00
 ...
 */
#define RADIANT_WIRE_MESG_EVENT_ID                           0x01
 ...
 */
#define RADIANT_WIRE_MESG_VERSION_ID                         0x3E
 ...
 */
#define RADIANT_WIRE_MESG_NETWORK_KEY_ID                     0x46
 ...
 */
#define RADIANT_WIRE_MESG_RADIO_TX_POWER_ID                  0x47

/* Continuous-wave test transmit. Not bridged. [rev5.1 sec 9.5, host-api] */
#define RADIANT_WIRE_MESG_RADIO_CW_MODE_ID                   0x48

/* [channel, waveform lo, waveform hi]. Search duty cycle. [bridge] */
#define RADIANT_WIRE_MESG_SEARCH_WAVEFORM_ID                 0x49
 ...
 */
#define RADIANT_WIRE_MESG_SYSTEM_RESET_ID                    0x4A

/* [channel]. [bridge, tools] */
#define RADIANT_WIRE_MESG_OPEN_CHANNEL_ID                    0x4B

/*
 * [channel]. Asynchronous: the channel is not free until EVENT_CHANNEL_CLOSED
 * arrives. [bridge, tools]
 */
#define RADIANT_WIRE_MESG_CLOSE_CHANNEL_ID                   0x4C
 ...
 */
#define RADIANT_WIRE_MESG_ACKNOWLEDGED_DATA_ID               0x4F
 ...
 * [bridge, tools]
 */
#define RADIANT_WIRE_MESG_BURST_DATA_ID                      0x50
 ...
 */
#define RADIANT_WIRE_MESG_CHANNEL_ID_ID                      0x51

/* [channel, status]. Requested with MESG_REQUEST. [bridge, tools] */
#define RADIANT_WIRE_MESG_CHANNEL_STATUS_ID                  0x52

/* Enter continuous-wave test mode. Not bridged. [rev5.1 sec 9.5, host-api] */
#define RADIANT_WIRE_MESG_RADIO_CW_INIT_ID                   0x53
 ...
 */
#define RADIANT_WIRE_MESG_CAPABILITIES_ID                    0x54
 ...
 */
#define RADIANT_WIRE_MESG_CHANNEL_CRC_MODE_ID                0x58

/*
 * [channel, device number lo, device number hi, device type, transmission
 * type, list index]. [bridge]
 */
#define RADIANT_WIRE_MESG_ID_LIST_ADD_ID                     0x59

/* [channel, list size, include/exclude flag]. [bridge] */
#define RADIANT_WIRE_MESG_ID_LIST_CONFIG_ID                  0x5A
 ...
 * only there. [bridge]
 */
#define RADIANT_WIRE_MESG_OPEN_RX_SCAN_MODE_ID               0x5B
 ...
 */
#define RADIANT_WIRE_MESG_EXT_BROADCAST_DATA_ID              0x5D

/*
 * Legacy extended acknowledged data. See MESG_EXT_BROADCAST_DATA_ID. [rev5.1
 * sec 9.5, host-api]
 */
#define RADIANT_WIRE_MESG_EXT_ACKNOWLEDGED_DATA_ID           0x5E

/*
 * Legacy extended burst data. See MESG_EXT_BROADCAST_DATA_ID. [rev5.1 sec
 * 9.5, host-api]
 */
#define RADIANT_WIRE_MESG_EXT_BURST_DATA_ID                  0x5F
 ...
 * readme]
 */
#define RADIANT_WIRE_MESG_CHANNEL_RADIO_TX_POWER_ID          0x60

/*
 * Read the device serial number. Not bridged. [rev5.1 sec 9.5 + verify:sdk-
 * ant-shim]
 */
#define RADIANT_WIRE_MESG_GET_SERIAL_NUM_ID                  0x61

/*
 * [channel, timeout]. Low-priority search timeout, in 2.5 s increments.
 * [bridge]
 */
#define RADIANT_WIRE_MESG_SET_LP_SEARCH_TIMEOUT_ID           0x63
 ...
 * shim]
 */
#define RADIANT_WIRE_MESG_SERIAL_NUM_SET_CHANNEL_ID_ID       0x65
 ...
 */
#define RADIANT_WIRE_MESG_XTAL_ENABLE_ID                     0x6D
 ...
 */
#define RADIANT_WIRE_MESG_ADV_BURST_DATA_ID                  0x72
 ...
 */
#define RADIANT_WIRE_MESG_EVENT_BUFFERING_CONFIG_ID          0x74

/* [channel, priority]. [bridge, rev5.1 sec 9.5 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_MESG_SET_SEARCH_CH_PRIORITY_ID          0x75
 ...
 */
#define RADIANT_WIRE_MESG_HIGH_DUTY_SEARCH_MODE_ID           0x77
 ...
 * (RADIANT_WIRE_MESG_CONFIG_ADV_BURST_REQ_CAPABILITIES_SIZE); 0x01 -> 10
 * bytes (RADIANT_WIRE_MESG_CONFIG_ADV_BURST_REQ_CONFIG_SIZE), selected by
 * byte 0 of the MESG_REQUEST that asked, which the reply does not repeat.
 ...
 * reader. [bridge, tools]
 */
#define RADIANT_WIRE_MESG_CONFIG_ADV_BURST_ID                0x78
 ...
 * (RADIANT_WIRE_MESG_EVENT_FILTER_CONFIG_REQ_SIZE), selected by nothing -
 * there is only one shape. One shape, one byte longer than the command. The
 * `2..3` on payload_len above is the union of the two and predates this
 * field; it is left as it stands because tools/ant_conformance.py derives its
 * malformed-short and malformed-long cases from those bounds, so narrowing it
 * would change the generated case set and the committed Tier 1 reference
 ...
 */
#define RADIANT_WIRE_MESG_EVENT_FILTER_CONFIG_ID             0x79
 ...
 */
#define RADIANT_WIRE_MESG_SDU_CONFIG_ID                      0x7A
 ...
 */
#define RADIANT_WIRE_MESG_SDU_SET_MASK_ID                    0x7B
 ...
 */
#define RADIANT_WIRE_MESG_USER_CONFIG_PAGE_ID                0x7C
 ...
 * (RADIANT_WIRE_MESG_CONFIG_ENCRYPT_REQ_CAPABILITIES_SIZE); 0x01 -> 5 bytes
 * (RADIANT_WIRE_MESG_CONFIG_ENCRYPT_REQ_CONFIG_ID_SIZE); 0x02 -> 20 bytes
 * (RADIANT_WIRE_MESG_CONFIG_ENCRYPT_REQ_CONFIG_USER_DATA_SIZE), selected by
 * the info type the reply echoes at byte 0. Three reply shapes behind one id,
 * and the reply says which it is: the ENCRYPTION_INFO_GET_* type is echoed at
 * byte 0, so a reader with no memory of the request can still check the
 * length exactly. An index that is not one of these three is refused with a
 ...
 */
#define RADIANT_WIRE_MESG_SET_ENCRYPT_INFO_ID                0x7F

/* [channel, cycles]. [bridge, rev5.1 sec 9.5 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_MESG_ACTIVE_SEARCH_SHARING_ID           0x81
 ...
 * + verify:sdk-ant-shim]
 */
#define RADIANT_WIRE_MESG_ECS_ENABLE_ID                      0x89
 ...
 */
#define RADIANT_WIRE_MESG_PENDING_TRANSMIT_CLEAR_ID          0x8C
 ...
 * shim]
 */
#define RADIANT_WIRE_MESG_SERIAL_ERROR_ID                    0xAE

/*
 * RADIANT_WIRE_MESG_RSSI_SEARCH_THRESHOLD_ID is UNRESOLVED. Proximity search
 ...
 * rather than merely unverified. Recover it once the value is known, in
 * protocol/ant_wire.yaml, and regenerate; see the unresolved table in
 * docs/ant-serial-protocol.md. [host-api + verify:sdk-ant-shim]
 */

/*
 * RADIANT_WIRE_MESG_SLEEP_ID is UNRESOLVED. Put the device into its low-power
 * sleep state. Implied by the ANT_DLL export ANT_SleepMessage, which Zwift
 ...
 * either. Recover it once the value is known, in protocol/ant_wire.yaml, and
 * regenerate; see the unresolved table in docs/ant-serial-protocol.md. [host-
 * api + verify:sdk-ant-shim]
 */
...
#define RADIANT_WIRE_MESG_RESPONSE_EVENT_SIZE                3

/* [reason]. [bridge] */
#define RADIANT_WIRE_MESG_STARTUP_MESG_SIZE                  1

/* Nine bytes, confirmed by the observed reply 080800b23200fd8d0f. [observed] */
#define RADIANT_WIRE_MESG_CAPABILITIES_SIZE                  9
 ...
 * verify:sdk-ant-shim]
 */
#define RADIANT_WIRE_MESG_VERSION_SIZE                       20

/* [channel, status]. [inferred + verify:sdk-ant-shim] */
#define RADIANT_WIRE_MESG_CHANNEL_STATUS_SIZE                2

/* [channel, number lo, number hi, device type, transmission type]. [bridge] */
#define RADIANT_WIRE_MESG_CHANNEL_ID_SIZE                    5

/* [channel, period lo, period hi]. [bridge] */
#define RADIANT_WIRE_MESG_CHANNEL_MESG_PERIOD_SIZE           3

/* [channel, frequency]. [bridge] */
#define RADIANT_WIRE_MESG_CHANNEL_RADIO_FREQ_SIZE            2

/* [channel, mode]. [inferred + verify:sdk-ant-shim] */
#define RADIANT_WIRE_MESG_CHANNEL_CRC_MODE_SIZE              2

/* [channel, priority]. [inferred + verify:sdk-ant-shim] */
#define RADIANT_WIRE_MESG_SET_SEARCH_CH_PRIORITY_SIZE        2

/* [channel, pending]. [inferred + verify:sdk-ant-shim] */
#define RADIANT_WIRE_MESG_PENDING_TRANSMIT_GET_SIZE          2

/* [filler, config bits]. [bridge] */
#define RADIANT_WIRE_MESG_ANTLIB_CONFIG_SIZE                 2

/* [channel, cycles]. [inferred + verify:sdk-ant-shim] */
#define RADIANT_WIRE_MESG_ACTIVE_SEARCH_SHARING_REQ_SIZE     2

/*
 * [filler, filter lo, filter hi] - one byte longer than the command that set
 * it. [bridge, tools]
 */
#define RADIANT_WIRE_MESG_EVENT_FILTER_CONFIG_REQ_SIZE       3
 ...
 * tools]
 */
#define RADIANT_WIRE_MESG_CONFIG_ADV_BURST_REQ_CONFIG_SIZE   10
 ...
 */
#define RADIANT_WIRE_MESG_CONFIG_ADV_BURST_REQ_CAPABILITIES_SIZE 4

/* [info type, supported mode]. [bridge] */
#define RADIANT_WIRE_MESG_CONFIG_ENCRYPT_REQ_CAPABILITIES_SIZE 2

/* [info type, crypto id[4]]. [bridge] */
#define RADIANT_WIRE_MESG_CONFIG_ENCRYPT_REQ_CONFIG_ID_SIZE  5

/*
 * [info type, custom user data[19]]. The longest frame body the parser ever
 * sees. [bridge, tools]
 */
#define RADIANT_WIRE_MESG_CONFIG_ENCRYPT_REQ_CONFIG_USER_DATA_SIZE 20
...
#define RADIANT_WIRE_EXT_PARAM_ALWAYS_SEARCH                 0x01

/*
 * Frequency agility enable. ANT+ profiles forbid it. [rev5.1 sec 5.2.1 +
 * verify:sdk-ant-shim]
 */
#define RADIANT_WIRE_EXT_PARAM_FREQUENCY_AGILITY             0x04

/*
 * Automatic shared-slave address management. [rev5.1 sec 5.2.1 + verify:sdk-
 * ant-shim]
 */
#define RADIANT_WIRE_EXT_PARAM_AUTO_SHARED_SLAVE             0x08

/* Fast channel initiation. [readme] */
#define RADIANT_WIRE_EXT_PARAM_FAST_INITIATION_MODE          0x10

/* Asynchronous transmission channel. [readme] */
#define RADIANT_WIRE_EXT_PARAM_ASYNC_TX_MODE                 0x20
...
#define RADIANT_WIRE_STATUS_UNASSIGNED_CHANNEL               0x00
 ...
 */
#define RADIANT_WIRE_RADIO_TX_POWER_LVL_0                    0x00

/* -12 dBm. [bridge] */
#define RADIANT_WIRE_RADIO_TX_POWER_LVL_1                    0x01

/* -4 dBm. [bridge] */
#define RADIANT_WIRE_RADIO_TX_POWER_LVL_2                    0x02

/*
 * 0 dBm. The ANT default, and what a host sends when it has no opinion - the
 * common case. [bridge]
 */
#define RADIANT_WIRE_RADIO_TX_POWER_LVL_3                    0x03
 ...
 */
#define RADIANT_WIRE_RADIO_TX_POWER_LVL_4                    0x04
 ...
 */
#define RADIANT_WIRE_RADIO_TX_POWER_LVL_5                    0x05

/*
 * Names a raw register value rather than a level, so it is passed through
 * untouched. [bridge]
 */
#define RADIANT_WIRE_RADIO_TX_POWER_LVL_CUSTOM               0x80
 ...
 */
#define RADIANT_WIRE_LIB_CONFIG_RADIO_CONFIG_ALWAYS          0x01
 ...
 * ms. [tools (ant_verify)]
 */
#define RADIANT_WIRE_LIB_CONFIG_MESG_OUT_INC_TIME_STAMP      0x20

/*
 * Append RSSI. The difference between a packet lost to a collision and one
 * lost to a fade. [tools (ant_verify)]
 */
#define RADIANT_WIRE_LIB_CONFIG_MESG_OUT_INC_RSSI            0x40
 ...
 * [bridge, tools]
 */
#define RADIANT_WIRE_LIB_CONFIG_MESG_OUT_INC_DEVICE_ID       0x80

/*
 * RADIANT_WIRE_LIB_CONFIG_DEVICE_ID_ONLY is a Python-side alias of an
 * identical value and is deliberately not defined here. Alias: the narrow
 * setting ant_scan.py and ant_session.py use - identity, nothing else.
 */

/*
 * Channel id + RSSI + RX timestamp, all three. What ant_verify.py asks for,
 * and what radiant must assemble: the timestamp is the figure the timing gate
 * is read against. [tools (ant_verify)]
 */
#define RADIANT_WIRE_LIB_CONFIG_ALL_EXT_FIELDS               0xE0

/*
 * Passed to the clear path when a host sends 0x6E with a zero config byte.
 * [bridge + verify:sdk-ant-shim]
 */
#define RADIANT_WIRE_LIB_CONFIG_MASK_ALL                     0xFF
 ...
 * (ant_verify)]
 */
#define RADIANT_WIRE_RSSI_MEASUREMENT_TYPE_DBM               0x20
...
/*
 * Power-on. This firmware never sends it: the startup message is emitted only
 * in answer to MESG_SYSTEM_RESET, which reports STARTUP_COMMAND_RESET. [tools
 * (ant_probe)]
 */
#define RADIANT_WIRE_STARTUP_POWER_ON_RESET                  0x00

/* Hardware reset line. [tools (ant_probe)] */
#define RADIANT_WIRE_STARTUP_HARDWARE_RESET_LINE             0x01

/* Watchdog. [tools (ant_probe)] */
#define RADIANT_WIRE_STARTUP_WATCH_DOG_RESET                 0x02

/*
 * Reset by MESG_SYSTEM_RESET. What this firmware reports, and the only reason
 * it ever reports: send_startup() in apps/common/ant_serial_bridge.c has one
 * caller, the reset arm of dispatch(). It sent 0x00 until 2026-08-20, which
 * told hosts the stick had cold-booted and defeated the one thing this byte
 * is watched for - telling an unexpected reset apart from the host's own. The
 * basis for 0x20 is sdk-ant's own header, which ant_radio_sdk_ant.c pins with
 * ANTW_EQ(STARTUP_COMMAND_RESET, RESET_CMD); no observed retail-stick capture
 * of this frame exists here, and the 0x20 frame vectors are tagged hand, not
 * observed. [tools (ant_probe)]
 */
#define RADIANT_WIRE_STARTUP_COMMAND_RESET                   0x20

/* Synchronous serial reset. [tools (ant_probe)] */
#define RADIANT_WIRE_STARTUP_SYNCHRONOUS_RESET               0x40

/* Resume from suspend. [tools (ant_probe)] */
#define RADIANT_WIRE_STARTUP_SUSPEND_RESET                   0x80
...
#define RADIANT_WIRE_EVENT_RX_SEARCH_TIMEOUT                 0x01
 ...
 */
#define RADIANT_WIRE_EVENT_RX_FAIL                           0x02
 ...
 * 9.5.6]
 */
#define RADIANT_WIRE_EVENT_RX_DATA_OVERFLOW                  0x0B
 ...
 */
#define RADIANT_WIRE_EVENT_TRANSFER_NEXT_DATA_BLOCK          0x11
 ...
 */
#define RADIANT_WIRE_RESPONSE_NO_ERROR                       0x00
 ...
 * verify:sdk-ant-shim]
 */
#define RADIANT_WIRE_TRANSFER_IN_PROGRESS                    0x1F

/*
 * Burst packets arrived out of order. [rev5.1 sec 9.5.6 + verify:sdk-ant-
 * shim]
 */
#define RADIANT_WIRE_TRANSFER_SEQUENCE_NUMBER_ERROR          0x20

/* Burst aborted. [rev5.1 sec 9.5.6 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_TRANSFER_IN_ERROR                       0x21
 ...
 * shim]
 */
#define RADIANT_WIRE_TRANSFER_BUSY                           0x22

/*
 * Payload longer than the message allows. [rev5.1 sec 9.5.6 + verify:sdk-ant-
 * shim]
 */
#define RADIANT_WIRE_MESSAGE_SIZE_EXCEEDS_LIMIT              0x27
 ...
 */
#define RADIANT_WIRE_INVALID_PARAMETER_PROVIDED              0x33

/*
 * The host is sending faster than the serial layer drains. [rev5.1 sec 9.5.6
 * + verify:sdk-ant-shim]
 */
#define RADIANT_WIRE_EVENT_SERIAL_QUE_OVERFLOW               0x34

/*
 * The event queue overflowed - events were dropped. [rev5.1 sec 9.5.6 +
 * verify:sdk-ant-shim]
 */
#define RADIANT_WIRE_EVENT_QUE_OVERFLOW                      0x35
...
#define RADIANT_WIRE_ADV_BURST_MODE_DISABLE                  0x00

/* Enable byte: on. [tools (ant_features)] */
#define RADIANT_WIRE_ADV_BURST_MODE_ENABLE                   0x01

/* RF payload size code: 8 bytes. [inferred + verify:sdk-ant-shim] */
#define RADIANT_WIRE_ADV_BURST_MODES_SIZE_8_BYTES            0x01

/* RF payload size code: 16 bytes. [inferred + verify:sdk-ant-shim] */
#define RADIANT_WIRE_ADV_BURST_MODES_SIZE_16_BYTES           0x02

/*
 * RF payload size code: 24 bytes. What the stub advertises and what
 * ant_features.py configures. [stub, tools]
 */
#define RADIANT_WIRE_ADV_BURST_MODES_SIZE_24_BYTES           0x03

/* Optional-modes bit: frequency hopping. [stub, tools] */
#define RADIANT_WIRE_ADV_BURST_MODES_FREQ_HOP                0x01
 ...
 * off. [stub, tools]
 */
#define RADIANT_WIRE_INVALID_SDU_MASK                        0xFF
 ...
 * verify:sdk-ant-shim]
 */
#define RADIANT_WIRE_SDU_MASK_ACK_CONFIG_BIT                 0x80
...
#define RADIANT_WIRE_ENCRYPTION_DISABLED_MODE                0x00

/* Write: 4-byte crypto id. [tools (ant_features)] */
#define RADIANT_WIRE_ENCRYPTION_INFO_SET_CRYPTO_ID           0x00

/* Write: 19 bytes of custom user data. [tools (ant_features)] */
#define RADIANT_WIRE_ENCRYPTION_INFO_SET_CUSTOM_USER_DATA    0x01
 ...
 */
#define RADIANT_WIRE_ENCRYPTION_INFO_SET_RNG_SEED            0x02

/* Read: the supported encryption mode. [tools (ant_features)] */
#define RADIANT_WIRE_ENCRYPTION_INFO_GET_SUPPORTED_MODE      0x00

/* Read: the 4-byte crypto id. [tools (ant_features)] */
#define RADIANT_WIRE_ENCRYPTION_INFO_GET_CRYPTO_ID           0x01

/* Read: the 19 bytes of custom user data. [tools (ant_features)] */
#define RADIANT_WIRE_ENCRYPTION_INFO_GET_CUSTOM_USER_DATA    0x02

/*
 * Bytes of custom user data. One info-type byte plus these fills
 * MAX_SIZE_VALUE exactly. [stub, tools]
 */
#define RADIANT_WIRE_ENCRYPTION_USER_DATA_SIZE               19
 ...
 */
#define RADIANT_WIRE_ENCRYPTION_KEY_SIZE                     16
 ...
 * verify:sdk-ant-shim]
 */
#define RADIANT_WIRE_MAX_SUPPORTED_ENCRYPTION_MODE           0x02
 ...
 * protocol's natural ceiling, and why radiant is sized for 32 from the first
 ...
 * [bridge]
 */
#define RADIANT_WIRE_BURST_HEADER_CHANNEL_MASK               0x1F

/* Sequence number occupies bits 5-6. [bridge] */
#define RADIANT_WIRE_BURST_HEADER_SEQ_SHIFT                  5

/* Sequence number after shifting: 0-3, wrapping. [bridge] */
#define RADIANT_WIRE_BURST_HEADER_SEQ_MASK                   0x03

/* Bit 7: this is the last packet of the transfer. [bridge, tools] */
#define RADIANT_WIRE_BURST_HEADER_LAST                       0x80
 ...
 */
#define RADIANT_WIRE_RADIANT_PAIR_LEAVE                      0x00
 ...
 */
#define RADIANT_WIRE_RADIANT_PAIR_ENTER                      0x01
 ...
 * 8)]
 */
#define RADIANT_WIRE_RADIANT_PAIR_SCALAR                     0x02
 ...
 */
#define RADIANT_WIRE_RADIANT_PAIR_EXCHANGE                   0x03
...
#define RADIANT_WIRE_CAPABILITIES_OFFSET_MAX_CHANNELS        0

/* byte 1 - max_networks. Network keys the stack can hold. */
#define RADIANT_WIRE_CAPABILITIES_OFFSET_MAX_NETWORKS        1

/*
 * byte 2 - standard_options. Negative capabilities: a set bit means the
 * feature is ABSENT.
 */
#define RADIANT_WIRE_CAPABILITIES_OFFSET_STANDARD_OPTIONS    2

/* Cannot receive. [rev5.1 sec 9.5.7.4 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_CAPABILITIES_NO_RECEIVE_CHANNELS        0x01

/* Cannot transmit. [rev5.1 sec 9.5.7.4 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_CAPABILITIES_NO_TRANSMIT_CHANNELS       0x02

/* No receive messages. [rev5.1 sec 9.5.7.4 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_CAPABILITIES_NO_RECEIVE_MESSAGES        0x04

/* No transmit messages. [rev5.1 sec 9.5.7.4 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_CAPABILITIES_NO_TRANSMIT_MESSAGES       0x08

/* No acknowledged data. [rev5.1 sec 9.5.7.4 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_CAPABILITIES_NO_ACKD_MESSAGES           0x10

/* No burst. [rev5.1 sec 9.5.7.4 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_CAPABILITIES_NO_BURST_MESSAGES          0x20

/*
 * byte 3 - advanced_options. Positive capabilities from here on: a set bit
 * means present.
 */
#define RADIANT_WIRE_CAPABILITIES_OFFSET_ADVANCED_OPTIONS    3

/* MESG_NETWORK_KEY is supported. [stub] */
#define RADIANT_WIRE_CAPABILITIES_NETWORK_ENABLED            0x02

/* The device has a readable serial number. [stub] */
#define RADIANT_WIRE_CAPABILITIES_SERIAL_NUMBER_ENABLED      0x08

/* MESG_CHANNEL_RADIO_TX_POWER (0x60) is supported. [stub] */
#define RADIANT_WIRE_CAPABILITIES_PER_CHANNEL_TX_POWER_ENABLED 0x10

/* MESG_SET_LP_SEARCH_TIMEOUT is supported. [stub] */
#define RADIANT_WIRE_CAPABILITIES_LOW_PRIORITY_SEARCH_ENABLED 0x20

/* SensRcore scripting. [rev5.1 sec 9.5.7.4 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_CAPABILITIES_SCRIPT_ENABLED             0x40

/*
 * Inclusion/exclusion lists (0x59, 0x5A). [rev5.1 sec 9.5.7.4 + verify:sdk-
 * ant-shim]
 */
#define RADIANT_WIRE_CAPABILITIES_SEARCH_LIST_ENABLED        0x80

/* byte 4 - advanced_options_2. */
#define RADIANT_WIRE_CAPABILITIES_OFFSET_ADVANCED_OPTIONS_2  4

/*
 * MESG_ENABLE_LED_FLASH. Reported OFF here, which is why a host that has
 * ANT_EnableLED never sends 0x68. [readme]
 */
#define RADIANT_WIRE_CAPABILITIES_LED_ENABLED                0x01

/* Extended output fields - the whole lib config mechanism. [stub] */
#define RADIANT_WIRE_CAPABILITIES_EXT_MESSAGE_ENABLED        0x02

/*
 * MESG_OPEN_RX_SCAN_MODE. Reported OFF in this generated reply, which is why
 * a host that has ANT_OpenRxScanMode never sends 0x5B on this build. radiant
 ...
 */
#define RADIANT_WIRE_CAPABILITIES_SCAN_MODE_ENABLED          0x04

/* MESG_PROX_SEARCH_CONFIG. [rev5.1 sec 9.5.7.4 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_CAPABILITIES_PROX_SEARCH_ENABLED        0x10

/* The optional fourth byte of MESG_ASSIGN_CHANNEL. [stub] */
#define RADIANT_WIRE_CAPABILITIES_EXT_ASSIGN_ENABLED         0x20

/* ANT-FS file system. [rev5.1 sec 9.5.7.4 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_CAPABILITIES_FS_ANTFS_ENABLED           0x40

/* FIT1 support. [rev5.1 sec 9.5.7.4 + verify:sdk-ant-shim] */
#define RADIANT_WIRE_CAPABILITIES_FIT1_ENABLED               0x80

/*
 * byte 5 - max_sensrcore_channels. SensRcore scripting channels. Zero
 * everywhere here.
 */
#define RADIANT_WIRE_CAPABILITIES_OFFSET_MAX_SENSRCORE_CHANNELS 5

/*
 * byte 6 - advanced_options_3. The tech-bulletin features. This is the byte
 * ant_features.py walks.
 */
#define RADIANT_WIRE_CAPABILITIES_OFFSET_ADVANCED_OPTIONS_3  6

/* MESG_CONFIG_ADV_BURST (0x78) and 24-byte burst packets. [stub, tools] */
#define RADIANT_WIRE_CAPABILITIES_ADVANCED_BURST_ENABLED     0x01
 ...
 */
#define RADIANT_WIRE_CAPABILITIES_EVENT_BUFFERING_ENABLED    0x02

/* MESG_EVENT_FILTER_CONFIG (0x79). [stub, tools] */
#define RADIANT_WIRE_CAPABILITIES_EVENT_FILTERING_ENABLED    0x04

/*
 * MESG_HIGH_DUTY_SEARCH_MODE (0x77). Advertised and not bridged, on purpose -
 * see the README. [tools, readme]
 */
#define RADIANT_WIRE_CAPABILITIES_HIGH_DUTY_SEARCH_ENABLED   0x08

/* MESG_ACTIVE_SEARCH_SHARING (0x81). [tools (ant_features)] */
#define RADIANT_WIRE_CAPABILITIES_SEARCH_SHARING_ENABLED     0x10

/*
 * Radio coexistence configuration. No host API reaches it. [tools
 * (ant_features)]
 */
#define RADIANT_WIRE_CAPABILITIES_RADIO_COEX_CONFIG_ENABLED  0x20

/* MESG_SDU_CONFIG / MESG_SDU_SET_MASK (0x7A, 0x7B). [stub, tools] */
#define RADIANT_WIRE_CAPABILITIES_SELECTIVE_DATA_UPDATE_ENABLED 0x40
 ...
 */
#define RADIANT_WIRE_CAPABILITIES_ENCRYPTED_CHANNEL_ENABLED  0x80
 ...
 * byte used to be.
 */
#define RADIANT_WIRE_CAPABILITIES_OFFSET_ADVANCED_OPTIONS_4  7
 ...
 */
#define RADIANT_WIRE_CAPABILITIES_RFACTIVE_NOTIFICATION_ENABLED 0x01

/*
 * Data filtering. Clear in the observed reply. [sdk-ant-shim + verify:sdk-
 * ant-shim]
 */
#define RADIANT_WIRE_CAPABILITIES_DATA_FILTERING_ENABLED     0x02

/*
 * Search uplink. Set in the observed reply. [sdk-ant-shim + verify:sdk-ant-
 * shim]
 */
#define RADIANT_WIRE_CAPABILITIES_SEARCH_UPLINK_ENABLED      0x04
 ...
 * shim]
 */
#define RADIANT_WIRE_CAPABILITIES_GROUP_TRANSMITTER_INITIATION_ENABLED 0x08
 ...
 */
#define RADIANT_WIRE_CAPABILITIES_OFFSET_ADVANCED_OPTIONS_5  8
 ...
 * verify:sdk-ant-shim]
 */
#define RADIANT_WIRE_CAPABILITIES_CHANNEL_START_OFFSET_ENABLED 0x01

/*
 * Background searching channel uplink. Set in the observed reply. [sdk-ant-
 * shim + verify:sdk-ant-shim]
 */
#define RADIANT_WIRE_CAPABILITIES_SEARCHING_CHANNEL_UPLINK_ENABLED 0x02

/*
 * ID-match fix for a shared-channel RX burst transfer. Set in the observed
 * reply. [sdk-ant-shim + verify:sdk-ant-shim]
 */
#define RADIANT_WIRE_CAPABILITIES_ID_MATCH_FIX_ON_SHARED_CHANNEL_RXBURST 0x04
 ...
 * range. Lib config 0xE0 (RADIANT_WIRE_LIB_CONFIG_ALL_EXT_FIELDS) is a
 * third, unrelated namespace and has not moved - one is a frame's ID
 * field, the other a payload byte of message 0x6E.
 * ------------------------------------------------------------------------ */
 ...
 */
#define RADIANT_WIRE_MESG_RADIANT_SEC_CONFIG_ID              0xF1
 ...
 */
#define RADIANT_WIRE_MESG_RADIANT_SET_KEY_ID                 0xF2
 ...
 */
#define RADIANT_WIRE_MESG_RADIANT_EPOCH_ID                   0xF3
 ...
 */
#define RADIANT_WIRE_MESG_RADIANT_SEC_STATUS_ID              0xF4
 ...
 * byte stream identical to a build without it. [0] structure version, 2 (was
 * 1: a version-1, 24-byte reader still decodes correctly - everything it
 * reads kept its meaning); [1] flags, bit 0 = at least one counter has
 * saturated, so the whole set is a floor rather than a total; [2..3] ANT
 * events dropped because the USB TX queue was full; [4] deepest that queue
 * has been, in frames, out of ANT_TX_QUEUE_DEPTH; [5] deepest the radio event
 * queue has been, out of its own depth; [6..7] event-queue overflow marks;
 * [8..9] times bulk-OUT was left unarmed for host backpressure; [10..11]
 * frames refused for an unusable network key; [12..13] scheduler windows
 * missed; [14..15] failed; [16..17] denied by the arbiter; [18..19] burst
 * transfers that hit the 1000 ms back-pressure stall; [20..21] search windows
 * the pump declined to post WHILE a channel was still searching and its slot
 * was held for something else, which is discovery work outstanding that could
 * not get on the air; [22..23] bytes discarded by the host-frame parser while
 * hunting for SYNC (0xA4), i.e. framing lost outright, before version 2 this
 * was reserved and sent as zero; [24..25] frames that reached a full, in-
 * range XOR checksum and failed it - framed but corrupt, kept apart from
 * [22..23] on purpose (one points at a host out of step, the other at a noisy
 * link); [26..27] radio RX events whose channel op was no longer the one that
 * channel owned by the time they were processed; [28..29] USB bulk-IN
 * transfers that never completed within their timeout, i.e. the host stopped
 * polling. All are u16 LE and all saturate rather than wrap, which is what
 * the flag in [1] is for: it distinguishes 65535 from 65535-and-counting. THE
 * OTHER HALF OF [20..21] IS DELIBERATELY ABSENT. A decline because NO channel
 * was searching is discovery having succeeded, not failed, and it is not loss
 * - and the pump runs about 31 times a second regardless, so such a field
 * would climb forever on an idle dongle and saturate in about 35 minutes.
 * Measured on the first hardware read of this reply: 231 within nine seconds
 * of boot with no channel ever opened. Since saturation sets the flag in [1],
 * that one field would have made every OTHER field on the board read as a
 * floor. It lives in the SWEEP log line under CONFIG_RADIANT_SWEEP_DEBUG
 * instead. WHY THIS EXISTS. tools/ab_gates.toml's unexplained_loss.max = 0 is
 * a SITTING INVALIDATOR rather than a gate: a hole with no RX_FAIL means the
 * loss happened on the host or inside the dongle, and loss_accounting()
 * cannot tell those two apart. A firmware-side witness splits that bucket.
 * That check has already caught 0.4 pp of imaginary loss once; a second
 * source makes it sharper. And on a Feather - no debugger, the board most
 * people flash - the LOG_WRN that is the only record of a drop today does not
 * exist at all. DEPTHS 32 AND 64 ARE NOT THE ANSWER TO A NON-ZERO [2..3]. At
 * 3103 msg/s a 64-byte frame arrives every ~322 us, so depth 32 is about 10
 * ms of buffer. If the host stops reading for longer than that, a deeper
 * queue converts a drop into LATENCY - the wrong trade for a protocol whose
 * whole value is a 0.345 ms p50. [Phase 1.4; tools/ab_gates.toml
 * unexplained_loss]
 */
