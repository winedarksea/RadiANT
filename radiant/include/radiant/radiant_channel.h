 ...
 * (radiant/tests/src/test_channel.c still drives fake_radio to prove the
...
#include <radiant/radiant_frame.h>     /* struct radiant_channel_id, and the frame geometry */
#include <radiant/radiant_radio_hal.h> /* radiant_time_t, enum radiant_radio_status */
#include <radiant/radiant_wire.h>      /* RADIANT_WIRE_* - only for the _Static_assert block below */
 ...
 * radiant/tests/src/test_channel.c otherwise) - resolved at link time,
