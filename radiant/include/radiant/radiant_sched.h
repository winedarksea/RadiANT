 ...
 * reply - wants it at once. This is the only place in radiant that calls
 ...
 *     chunks - the only place in radiant that needs to know.
 ...
 * CONFIG_RADIANT_ED_SCAN, and when the backend's caps.has_ed_scan is
