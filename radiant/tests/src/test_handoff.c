 ...
 * src/profiles/profile_handoff.h, radiant/include/radiant/radiant_channel.h,
 * radiant/include/radiant/radiant_search.h and
 * radiant/tests/fake_radio.h, with layout expectations from
