...
Throwaway. It includes no `radiant`, touches no HAL and drives no RADIO.
...
| `t` | free-running TIMER continuity across timeslot edges | whether `radiant`'s 1 MHz absolute timebase survives under MPSL |
...
> **That is a requirement on P3, not a quirk of the spike.** `radiant`'s
...
| `radiant` | `timer20` | `boards/nrf54l15dk_nrf54l15_cpuapp.overlay` |
