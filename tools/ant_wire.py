...
MESSAGES = {
    ...
    0x5B: {
        ...
        "payload_len": '1..2',
        "bridged": False,
        "desc": 'Background scanning. Not bridged, and scan mode is reported OFF in the capabilities reply - which is why a host that has the call (ANT_OpenRxScanMode) never sends it.',
    },
    0x5D: {
